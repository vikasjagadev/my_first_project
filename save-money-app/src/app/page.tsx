...
import { Search, ShoppingCart, TrendingUp, Zap, Sparkles, Tag, ArrowRight, Loader2, Check, X, Plus, Minus, Trash2 } from "lucide-react";
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="flex items-end justify-between mb-8">
            <div>
              ...
              <p className="text-gray-400 mt-2">Showing {visibleProducts.length} of {filteredProducts.length} products</p>
            </div>
          </div>
              ...
              {visibleProducts.map((product) => (
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    ...
                    <h3 className="text-lg font-bold mb-3 line-clamp-1 group-hover:text-primary transition-colors">{product.name}</h3>
          ...
          {hasMore && (
            <div className="mt-16 flex justify-center">
              <button 
                ...
                className="bg-white/5 hover:bg-white/10 border border-white/10 px-8 py-3 rounded-full font-semibold transition-all flex items-center gap-2 text-white"
              >
              ...
              <div className="flex-1 overflow-y-auto p-6 space-y-6 scrollbar-hide">
                {cartItems.length === 0 ? (
                  <div className="h-full flex flex-col items-center justify-center text-gray-500">
                    ...
                    <button 
                      onClick={() => setIsOpen(false)}
                      className="mt-6 px-6 py-2 bg-primary text-white rounded-full font-semibold hover:bg-primary-hover transition-colors"
                    >
                      Start Shopping
                    </button>
                  </div>
                      ...
                      <div className="flex-1 flex flex-col justify-between">
                        ...
                        <div className="flex items-center justify-between mt-2">
                          <div className="flex items-center gap-1.5 text-[10px] text-gray-400 bg-white/5 px-2 py-1 rounded-full">
                            ...
                            +{item.rewards * item.quantity} Coins
                          </div>
              ...
              {cartItems.length > 0 && (
                <div className="p-6 border-t border-white/10 bg-background/80 backdrop-blur-md">
                  <div className="space-y-3 mb-6">
                    ...
                    <div className="flex justify-between text-sm items-center bg-primary/10 p-3 rounded-xl border border-primary/20">
                      <span className="text-primary font-medium">Total Rewards Earned:</span>
                      <span className="text-primary font-bold flex items-center gap-1">
                        <Sparkles className="w-4 h-4" /> {totalRewards} Coins
                      </span>
                    </div>
                  </div>
                  <button 
                    ...
                    className="w-full bg-primary hover:bg-primary-hover text-white py-4 rounded-xl font-bold text-lg shadow-[0_0_20px_rgba(16,185,129,0.3)] hover:shadow-[0_0_30px_rgba(16,185,129,0.5)] transition-all"
                  >
                    Proceed to Checkout
                  </button>
                </div>
